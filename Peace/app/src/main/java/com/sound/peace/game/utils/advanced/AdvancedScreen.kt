...
import com.sound.peace.game.utils.*
...
abstract class AdvancedScreen(
    ...
    override fun show() {
        ...
        backBackgroundImage.setOrigin(Align.center)
        backBackgroundImage.addAction(Acts.forever(Acts.sequence(
            Acts.scaleTo(1.05f, 1.05f, 0.5f),
